...
data_dir = "/Users/oziedokobi/Desktop/BAyesalabproject/faers_xml_2024q3/XML/FAERSdataMerge"
...
def main():
    ...
    concept_df = pd.read_csv("Norm/CONCEPT.csv", sep="\t", low_memory=False, on_bad_lines='skip')
    concept_df.drop(
